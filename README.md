    ...
    <div class="container py-8">
        ...
        <header class="text-center mb-8">
            <div class="flex flex-col sm:flex-row items-center justify-between">
                <img src="[[C:\Users\TyronVincentTrofeo\Downloads\deped logo.jpg](https://github.com/tyrofeo123/legal-practice/blob/main/deped%20logo.jpg?raw=true)](https://depedph.com/wp-content/uploads/2024/01/deped-logo-symbol-philippines.png)">
